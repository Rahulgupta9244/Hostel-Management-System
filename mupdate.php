...
if(isset($_POST['name1']))
    $s_id = $_POST['name1'];
 $res = mysqli_query($conn,"SELECT * FROM mess");
?>
...
<body>
    <form action="m1update.php" method="POST">
<div class="tag"> <center> <h1 style="font-family: 'Poppins', sans-serif;">Update Mess Details<br><br></h1>  
 Enter Mess Staff ID : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name1"><br><br>

Enter the attribute to be updated : &nbsp;<input type="text" name="name2"><br><br>
 Enter new value of the attibute : &nbsp;&nbsp;&nbsp;<input type="text" name="name3"><br><br><br>
