...
if(isset($_POST['name']))
    $s_id = $_POST['name'];
 $res = mysqli_query($conn,"SELECT h_id FROM hostel");
?>
<!doctype html>
<html><head>
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
     <link rel="stylesheet" href="css/hdel.css">
    <style> .tag{ margin-top: 150px;}</style>
    </head>
<body>
    <form action="h1delete.php" method="POST">
<div class="tag"> <center> <h1 style="font-family: 'Poppins', sans-serif;">Delete Hostel Details<br><br></h1>  
 Enter Hostel ID : &nbsp;<input type="text" name="name"><br><br><br>
