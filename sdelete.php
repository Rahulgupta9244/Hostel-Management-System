...
if(isset($_POST['name']))
    $s_id = $_POST['name'];
 $res = mysqli_query($conn,"SELECT s_id FROM student");
?>
<!doctype html>
<html><head>
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
     <link rel="stylesheet" href="css/sdel.css">
    <style> .tag{ margin-top: 150px;}</style>
   </head>
<body>
    <form action="s1delete.php" method="POST">
<div class="tag"> <center> <h1 style="font-family: 'Poppins', sans-serif;">Delete Student Details<br><br></h1>  
 Enter Student ID : &nbsp;<input type="text" name="name"><br><br><br>
