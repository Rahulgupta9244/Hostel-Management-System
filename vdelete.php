...
if(isset($_POST['name']))
    $s_id = $_POST['name'];
 $res = mysqli_query($conn,"SELECT visitor_id FROM visitor");
?>
...
<html><head>
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="css/vdel.css">
    <style> .tag{ margin-top: 150px;}</style>
    </head>
<body>
    <form action="v1delete.php" method="POST">
<div class="tag"> <center> <h1 style="font-family: 'Poppins', sans-serif;
">Delete Visitor Details<br><br></h1>  
 Enter Visitor ID: &nbsp;<input type="text" name="name"><br><br><br>
