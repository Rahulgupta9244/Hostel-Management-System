...
<html><head>
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
     ...
     <link rel="stylesheet" href="css/supdate.css">
    <style> .tag{ margin-top: 150px;}</style>
    </head>
<body>
    <form action="update.php" method="POST">
<div class="tag"> <center> <h1 style="font-family: 'Poppins', sans-serif;">Update Student Details<br><br></h1>  
 Enter Student ID : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name1"><br><br>
 Enter the attribute to be updated : &nbsp;<input type="text" name="name2"><br><br>
 Enter new value : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name3"><br><br><br>
